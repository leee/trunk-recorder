...
//    $3be      (  1 channel )
//    $3c1-$3fe ( 62 channels)
// Channels are pre-defined for 8/9 trunks. If an OBT trunk, the first range
// gets used to to indicate both inbound and outbound channels, with radio
// programming determining frequencies.
...
#define OSW_CHAN_BAND_1_MIN \
  0x000  // Bandplan Range 1, also used for OBT channelization
#define OSW_CHAN_BAND_1_MAX \
  0x2f7  // Bandplan Range 1, also used for OBT channelization

#define OSW_BACKGROUND_IDLE 0x2f8
#define OSW_FIRST_CODED_PC 0x304
#define OSW_FIRST_NORMAL 0x308
#define OSW_FIRST_TY2AS1 \
  0x309  // Unused - we don't support Type I trunks (or in this case, Type IIi)
